...
5. Indien er sprake is van meermaals gepleegde exact dezelfde strafbare feiten waarbij er sprake is van andere omstandigheden, dan wordt er voor rekening gehouden met de meervoudige vorm van de straf.
6. 1 maand gevangenisstraf staat gelijk aan 1 minuut in de gevangenis.
7. Er geldt een maximumcelstraf van 100 maanden.
...
2. Een strafblad is altijd zichtbaar in het systeem, echter blijft een strafblad voor 30 dagen geldig. 
...
1. Wanneer tijdens een staandehouding of aanhouding aangetoond wordt dat het totaalbedrag van openstaande boetes boven de € 100000,- reikt, kan dit impact hebben op de strafeis.
...
3. Bij medeplichtigheid aan een strafbaar feit wordt de medeplichtigheids vorm toegepast.
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Poging tot plegen** | 20 maanden  |   |   |
| **Veroordeling voor plegen**  | 25 maanden  |  |   |
| **Meervoudig plegen**  | 35 maanden  |  |   |

### Artikel I-5 Geldige verklaring herkomst contanten (321 SR)

1. Wanneer er tijdens aanhouding van een persoon door Politie of Koninklijke Marechaussee een geldbedrag, hoger dan € 75000,- aan contanten aangetroffen wordt bij die persoon, zal er om geldige verklaring van herkomst gevraagd worden.
...
5. Wanneer lid 4 van toepassing is, noemen we de som geld nu "zwart geld"
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **poging tot plegen** |   | 10 uur  | € 1000,-  |
| **Veroordeling voor plegen**  |   | 15 uur  | € 1500,-  |
| **Meervoudig plegen**  |   | 20 uur  | € 2000,-  |
...
|  **poging tot plegen** | 20 maanden  |   |   |
| **Veroordeling voor plegen**  | 25 maanden  |   |   |
| **Meervoudig plegen**  | 30 maanden  |   |   |
| **plegen tegen ambtenaar in functie**  | 30 maanden  |   |   | 
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **poging tot plegen** |   | 15 uur  | € 1000,-  |
| **Veroordeling voor plegen**  |   | 20 uur  | € 2000,-  |
| **Meervoudig plegen**  |   | 25 uur  | € 3000,-  |
| **plegen tegen ambtenaar in functie**  | 30 maanden  |   |   | 
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **poging tot plegen** | 30 maanden  |  |   |
| **Veroordeling voor plegen**  | 35 maanden  |  |   |
| **meervoudig plegen**  | 40 maanden  |  |  |
| **plegen tegen ambtenaar in functie**  | 30 maanden  |   |   | 
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Poging tot plegen** | 35 maanden  |  |   |
| **Veroordeling voor plegen**  | 40 maanden  |  |   |
| **Meervoudig plegen**  | 45 maanden  |  |   |
| **plegen tegen ambtenaar in functie**  | 30 maanden  |   |   | 
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Poging tot veroordelen** |   | 15 uur | € 1000,-  |
| **Veroordeling voor plegen**  |   | 20 uur | € 3000,-  |
| **Meervoudig plegen**  | 11 maanden  |  |   |
| **plegen tegen de overheid**  | 30 maanden  |   |   | 
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Poging tot plegen** |   | 30 uur | € 3000,-  |
| **Veroordeling voor plegen**  | 20 maanden  |  |   |
| **Meervoudig plegen**  | 30 maanden  |  |   |
| **plegen tegen de overheid**  | 30 maanden  |   |   | 
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Poging tot plegen** | 90 maanden  |  | € 30000,-  |
| **Veroordeling voor plegen**  | 90 maanden  |  | € 40000,-  |
| **meervoudig plegen**  | 90 maanden  |  | € 55000,-  |
...
2. Hierbij is geen poging tot dood door schuld.
...
### Artikel III-1 Verkeers overtredingen (5 WVW)

1. Via het "F6" menu staan er meerdere verkeers boetes klaar, hier kan een ambtenaar gebruik van maken.
2. Een ambtenaar mag nooit een snelheids boete opleggen, op basis van een flits melding, om dubbele straf te voorkomen.
3. Als een ambtenaar een rijbewijs wil invorderen, dient de ambtenaar een officiele kloking aantoonbaar te hebben.
4. Een rijbewijs mag worden igevord als;
   1. Persoon harder dan 80km/u is geklokt;
   2. Persoon met zijn rijgedrag een ongeval met dood tot afloop heeft veroorzaakt.



### Artikel III-2 Vluchten van de politie (5a WvW)

1. Het is eenieder verboden opzettelijk een gegeven stopteken te negeren en een poging te doen om te vluchten van het stopteken.
2. Poging tot vluchten van de politie is niet van toepassing op die feit.

|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
| **Veroordeling voor plegen**  | 10 maanden  |  |   |
...
3. Poging tot Veroorzaken ongeval, met al dan niet licht lichamelijk letsel tot gevolg, is niet van toepassing
...
3. Poging tot Veroorzaken ongeval, met zwaar lichamelijk letsel tot gevolg, is niet van toepassing
...
3. Poging tot Veroorzaken ongeval, met de dood tot gevolg, is niet van toepassing.
...
3. Poging tot  Rijden onder invloed, is niet van toepassing
...
3. Poging tot rijden zonder rijbewijs, is niet van toepassing.

|   | *Celstraf*  | *Taakstraf*  | *boete*  | 
|---|---|---|---|
| **Veroordeling bij pleging**  |   | 15 uur | € 4000,-  | 
...
9. Als een voertuig eis ontbreekt krijgt persoon een kans om het direct aan te passen, anders een wok-status uitschrijven.
...
3. Een WOK-status is een status die vastgelegd is bij de Politie en Koninklijke marechaussee. Deze status kan na een reparatie of aanpassing van het voertuig door de ANWB, Politie of Koninklijke marechaussee verwijderd worden na een visuele controle van het voertuig.
...
3. Als het strafbare feit niet terug te vinden is via F6, zal deze handmatig ingevoerd worden.

|   |   |
|---|---|
| Blokkeren van de weg | € 15000,- |
| Maken van een U-turn daar waar dat niet is toegestaan | €15000 ,- |
| Rijden in een voertuig dat niet toegestaan is op de openbare weg | € 25000,-  |
| Maken van een Burnout  | € 12000,- |
| Onnodig Claxoneren | € 13000,-  |
| Over een doorgestrokken streep rijden  | € 13000,-  |
| Aan de verkeerde kant van de weg rijden (spookrijden) | € 15000,- |
| Stilstaan waar dit niet is toegestaan | € 6000,- |
| Onnodig links rijden | € 5000,-  |
| Doorrijden bij een stopbord | € 13500,- |
...
#### tabel Harddrugs: ingrediënten

|***ingrediënten***   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
| **Veroordeling bij plegen**  |   | 40 uur  | € 1000,-  |
| **Meervoudige pleging**  | 10 maanden  |   |   |

#### tabel Harddrugs: eindproducten
...
|---|---|---|---|
|  **Bezit voorhanden hebben** | 17 maanden  |  |   |
| **Inzetten als geweldsmiddel**  | 20 maanden  |  |   |
| **Meervoudig inzetten als geweldsmiddel**  | 25 maanden  |  |   |

| ***`Categorie 2`***  | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Bezit voorhanden hebben** | 25 maanden  |  |   |
| **Inzetten als geweldsmiddel**  | 35 maanden  |  |   |
| **Meervoudig inzetten als geweldsmiddel**  | 40 maanden  |  |   |
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Bezit voor handen hebben** |   |  | € 4000,-  |
| **Inzetten als geweldsmiddel**  |   | 20 uur  | € 5000,-  |
| **Meervoudig inzetten als geweldsmiddel**  | 15 maanden  |   |   |
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Veroordeling bij plegen** |    | 10 uur | € 2000,-  |
...
|   | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Poging tot plegen** | 15 maanden  |  |   |
| **veroordeling bij plegen**  | 20 maanden  |  |   |
| **Meervoudig plegen**  | 25 maanden  |  |   |

### Artikel V-5 Munitiebezit

1. Strafbaar is een persoon die munitie voorhanden heeft.
2. Een magazijn voor een pistool telt 16 kogels, een magazijn voor een SMG telt 20 kogels, een magazijn voor een AR telt 30 kogels en een magazijn voor een shotgun telt 10 kogels.

| ***`Categorie 1 Munitie`***  | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Bezit voor handen hebben** | 5 maanden  |  |   |
| **Inzetten als geweldsmiddel**  | 7 maanden  |  |   |
| **Meerdvoudig inzetten als geweldsmiddel**  | 10 maanden  |  |   |

| ***`Categorie 2 Munitie`***  | *Celstraf*  | *Taakstraf*  | *boete*  |
|---|---|---|---|
|  **Bezit voor handen hebben** | 7 maanden  |  |   |
| **Inzetten als geweldsmiddel**  | 10 maanden  |  |   |
